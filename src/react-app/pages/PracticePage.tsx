    ...
    <div className="page-content">
      ...
      <section className="solutions" id="solutions">
        <div className="section-header">
          ...
          <h2 className="section-title">{t('solutions.practice.title')}</h2>
        </div>
        <div className="solutions-content">
          <div className="solution-panel fade-in">
            <div className="solution-visual">
              <div className="visual-placeholder doctor-visual">
            ...
            <div className="solution-details">
              <h3>{t('solutions.practice.title')}</h3>
              <p className="solution-intro">
                {t('solutions.practice.intro')}
              </p>
              <ul className="solution-features">
                {(t('solutions.practice.features', { returnObjects: true }) as string[]).map((feature, index) => (
                  <li key={index}>
