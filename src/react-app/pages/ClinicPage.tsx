    ...
    <div className="page-content">
      ...
      <section className="solutions" id="solutions">
        <div className="section-header">
          ...
          <h2 className="section-title">{t('solutions.clinic.title')}</h2>
        </div>
        <div className="solutions-content">
          <div className="solution-panel fade-in">
            <div className="solution-visual">
              <div className="visual-placeholder clinic-visual">
            ...
            <div className="solution-details">
              <h3>{t('solutions.clinic.title')}</h3>
              <p className="solution-intro">
                {t('solutions.clinic.intro')}
              </p>
              <ul className="solution-features">
                {(t('solutions.clinic.features', { returnObjects: true }) as string[]).map((feature, index) => (
                  <li key={index}>
